<template>
    <div class="w-96 mx-auto">
        Index
        <Link class="text-sm" :href="route('project.index')">Back</Link>
    </div>
                        ...
                        <tbody class="bg-white dark:bg-slate-800">
                            <tr v-for="project in projects.data">
                                ...
                                <td
                                    ...
                                    {{ project.type.title }}</td>
                                <td
                                    class="border-b border-slate-100 dark:border-slate-700 p-4 pr-8 text-slate-500 dark:text-slate-400">
                                    {{ project.title }}</td>
                                <td
                                    class="border-b border-slate-100 dark:border-slate-700 p-4 pr-8 text-slate-500 dark:text-slate-400">
                                    {{ project.created_at_time }}</td>
                                <td
                                    class="border-b border-slate-100 dark:border-slate-700 p-4 pr-8 text-slate-500 dark:text-slate-400">
                                    {{ project.contracted_at }}</td>
                                <td
                                    class="border-b border-slate-100 dark:border-slate-700 p-4 pr-8 text-slate-500 dark:text-slate-400">
                                    {{ project.deadline }}</td>
                                <td
                                ...
                                <td
                                    class="border-b border-slate-100 dark:border-slate-700 p-4 pr-8 text-slate-500 dark:text-slate-400">
                                    {{ project.is_on_time }}</td>
                                <td
                                    class="border-b border-slate-100 dark:border-slate-700 p-4 pr-8 text-slate-500 dark:text-slate-400">
                                    {{ project.has_outsource }}</td>
                                <td
                                    class="border-b border-slate-100 dark:border-slate-700 p-4 pr-8 text-slate-500 dark:text-slate-400">
                                    {{ project.has_investors }}</td>
                                <td
                                    class="border-b border-slate-100 dark:border-slate-700 p-4 pr-8 text-slate-500 dark:text-slate-400">
                                    {{ project.service_count }}</td>
                                <td
                                    class="border-b border-slate-100 dark:border-slate-700 p-4 pr-8 text-slate-500 dark:text-slate-400">
                                    {{ project.worker_count }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
